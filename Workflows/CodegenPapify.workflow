...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        ...
        <dftools:data key="variables">
            <dftools:variable name="depth" value="4"/>
        </dftools:data>
    </dftools:task>
    ...
    <dftools:task
        pluginId="org.ietr.preesm.codegen.xtend.task.CodegenPapifyEngineTask" taskId="Papify Engine Task">
        <dftools:data key="variables"/>
    </dftools:task>
    ...
    <dftools:dataTransfer from="Scheduling" sourceport="DAG"
        targetport="DAG" to="Papify Engine Task"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario"
        targetport="scenario" to="Papify Engine Task"/>
    <dftools:dataTransfer from="Papify Engine Task" sourceport="DAG"
